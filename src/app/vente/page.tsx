...
export const metadata = {
  title: "Vente — VENTURE",
  description: "Annonces immobilières à la vente — filtres, pagination et recherche.",
};

export default async function VentePage({ searchParams }: { searchParams: Promise<Search> }) {
